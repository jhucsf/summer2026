...
**Important:**  For Milestone 1, there will be no credit for submissions that
don't compile successfully and no credit for late submissions.
...
Important: Your `Makefile` **must** use these options.  If your `Makefile` does
*not* compile your code with these options, you will forfeit all of the points
for design and coding style.
...
```
curl -O https://jhucsf.github.io/summer2026/assign/assign03/read01.trace
```
